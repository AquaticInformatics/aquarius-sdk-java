...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "22.1.0"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:22.1.0"
```
...
```sh
git clone --branch v22.1.0 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-22.1.0.jar`.
