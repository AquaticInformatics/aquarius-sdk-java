...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "17.2.30"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:17.2.30"
```
...
```sh
git clone --branch v17.2.30 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-17.2.30.jar`.
