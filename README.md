...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "21.3.1"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:21.3.1"
```
...
```sh
git clone --branch v21.3.1 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-21.3.1.jar`.
