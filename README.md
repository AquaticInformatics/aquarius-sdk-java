...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "21.2.0"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:21.2.0"
```
...
```sh
git clone --branch v21.2.0 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-21.2.0.jar`.
