...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "20.4.2"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:20.4.2"
```
...
```sh
git clone --branch v20.4.2 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-20.4.2.jar`.
