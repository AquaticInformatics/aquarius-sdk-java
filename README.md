...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "18.6.1"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:18.6.1"
```
...
```sh
git clone --branch v18.6.1 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-18.6.1.jar`.
