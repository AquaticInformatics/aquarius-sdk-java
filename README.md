...
```scala
libraryDependencies += "com.aquaticinformatics" % "aquarius.sdk" % "19.4.0"
```
...
```groovy
compile "com.aquaticinformatics:aquarius.sdk:19.4.0"
```
...
```sh
git clone --branch v19.4.0 https://github.com/AquaticInformatics/aquarius-sdk-java.git
cd aquarius-sdk-java
mvn package
```

The generated JAR file will be at `target/aquarius-sdk-19.4.0.jar`.
